...
/**
 * Created by hl4350hb on 9/27/17.
 */

public class ToDoListAdapter extends ArrayAdapter<ToDoItem> {
    // Usually the Activity that this ListView belongs to
    Context context;
    ...
    // place to insert the data about one particular list item into its own view
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        // time, or if Android can't find it for some reason it needs to be inflated from
        // the layout. If Android already has a reference to the View, it's provided as convertView
        // parameter so you don't need to inflate it again.
        if (rowView == null) {
